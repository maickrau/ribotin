...
int main(int argc, char** argv)
{
	...
	if (ontReadPaths.size() > 0)
	{
		...
		AlignONTReads(clusterParams.basePath, commonParams.GraphAlignerPath(), clusterParams.ontReadPath, clusterParams.basePath + "/allele-graph.gfa", clusterParams.basePath + "/ont-alns.gaf", clusterParams.numThreads);
